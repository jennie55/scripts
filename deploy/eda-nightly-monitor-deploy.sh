...
${SCP} ./eda-console-webapp.war eda@eda-admin-nightly:${TOMCATHOME}/${WARDEST}/eda-console-webapp.war > scp.log
SCPEXIT=$?
...
${SSH} eda@eda-admin-nightly "cd ~;./stop_all.sh" > stop.log 2>&1
STOPEXIT=$?
...
${SSH} eda@eda-admin-nightly "${RM} -rf ${TOMCATHOME}/${WARDEST}/eda-console-webapp" > clean.log 2>&1
CLEANEXIT=$?
...
${SSH} eda@eda-admin-nightly "cd ~;./start_all.sh" > start.log 2>&1
STARTEXIT=$?
